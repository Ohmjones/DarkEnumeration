...
def gobuster(url):
	...
	time.sleep(300) # Let's give Gobuster 5 minutes to complete or near completion before we hammer port 80 some more.
	wfuzz(url)
...
def nikto(url):
	...
	time.sleep(300) # Let's give Nikto 5 minutes to complete or near completion before we hammer port 80 some more.
	gobuster(url)
